...
@Component({
  ...
  templateUrl: './studentjoblist.component.html',
  styleUrls: ['./studentjoblist.component.scss']
})
export class StudentjoblistComponent implements OnInit {

  displayedColumns = ['userId', 'userName', 'progress', 'color','info'];
  ...
  ngOnInit() {
    ...
    sidenavInfo(){
      this.sidenav="addcourse";
    }
    sidenavCourse(){
      this.sidenav="jobinfo";
    }
}
  ...
  getSortedData(): UserData[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'info': [propertyA, propertyB] = [a.info, b.info]; break;
      }
